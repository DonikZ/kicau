      ...
      <section className="pt-40 pb-20 px-6 container mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 max-w-md mx-auto">
            ...
            <button className="whitespace-nowrap px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold flex items-center gap-2 hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
